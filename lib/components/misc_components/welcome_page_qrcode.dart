...
// /// - `_controller`: A MobileScannerController for controlling the QR code scanner.
...
//         if (_barcode != null) {
//           _scannedData = _barcode?.displayValue ?? '';
...
//         _scanSubscription = _controller!.barcodes.listen(_handleBarcode);
...
//         } else {
//           showAlert(
//             message: 'QR code scanner is not supported on web.',
//             type: 'danger',
//             duration: 3000,
//           );
//         }
